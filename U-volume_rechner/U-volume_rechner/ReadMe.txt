========================================================================
    KONSOLENANWENDUNG: U-volume_rechner-Projektübersicht
========================================================================

Diese U-volume_rechner-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U-volume_rechner-Anwendung besteht.


U-volume_rechner.vcxproj
...
U-volume_rechner.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U-volume_rechner.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
