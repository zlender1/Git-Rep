========================================================================
    KONSOLENANWENDUNG: U013-char_reminierung-Projektübersicht
========================================================================

Diese U013-char_reminierung-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U013-char_reminierung-Anwendung besteht.


U013-char_reminierung.vcxproj
...
U013-char_reminierung.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U013-char_reminierung.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
