========================================================================
    KONSOLENANWENDUNG: U015-funktionen-Projektübersicht
========================================================================

Diese U015-funktionen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U015-funktionen-Anwendung besteht.


U015-funktionen.vcxproj
...
U015-funktionen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U015-funktionen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
