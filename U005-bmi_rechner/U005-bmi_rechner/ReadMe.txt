========================================================================
    KONSOLENANWENDUNG: U005-bmi_rechner-Projektübersicht
========================================================================

Diese U005-bmi_rechner-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U005-bmi_rechner-Anwendung besteht.


U005-bmi_rechner.vcxproj
...
U005-bmi_rechner.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U005-bmi_rechner.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
