========================================================================
    KONSOLENANWENDUNG: U011-wurf_raten-Projektübersicht
========================================================================

Diese U011-wurf_raten-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U011-wurf_raten-Anwendung besteht.


U011-wurf_raten.vcxproj
...
U011-wurf_raten.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U011-wurf_raten.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
