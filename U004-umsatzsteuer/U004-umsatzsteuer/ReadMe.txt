========================================================================
    KONSOLENANWENDUNG: U004-umsatzsteuer-Projektübersicht
========================================================================

Diese U004-umsatzsteuer-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U004-umsatzsteuer-Anwendung besteht.


U004-umsatzsteuer.vcxproj
...
U004-umsatzsteuer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U004-umsatzsteuer.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
