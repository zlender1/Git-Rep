========================================================================
    KONSOLENANWENDUNG: U-subnet_rechner-Projektübersicht
========================================================================

Diese U-subnet_rechner-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U-subnet_rechner-Anwendung besteht.


U-subnet_rechner.vcxproj
...
U-subnet_rechner.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U-subnet_rechner.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
