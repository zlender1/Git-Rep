========================================================================
    KONSOLENANWENDUNG: U000-mix_uebungen-Projektübersicht
========================================================================

Diese U000-mix_uebungen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U000-mix_uebungen-Anwendung besteht.


U000-mix_uebungen.vcxproj
...
U000-mix_uebungen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U000-mix_uebungen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
