========================================================================
    KONSOLENANWENDUNG: U012-start-end_wert-Projektübersicht
========================================================================

Diese U012-start-end_wert-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre U012-start-end_wert-Anwendung besteht.


U012-start-end_wert.vcxproj
...
U012-start-end_wert.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen U012-start-end_wert.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
